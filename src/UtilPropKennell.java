...
public class UtilPropKennell {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\conne\\Desktop\\School\\Spring 2020\\CSCI 4830\\workspace4830-kennell\\workspaceCSCI4830-TE-Kennell\\webproject-TE-Kennell\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-TE-Kennell/config.properties";
